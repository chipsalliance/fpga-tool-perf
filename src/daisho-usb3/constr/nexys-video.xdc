...
create_clock -name sys_clk -period 7.5 [get_nets sys_clk]
...
create_clock -name phy_pipe_half_clk -period 8.0 [get_nets phy_pipe_half_clk]

create_clock -name phy_pipe_half_phase_clk -period 8.0 [get_nets phy_pipe_half_phase_clk]

create_clock -name phy_pipe_quarter_clk -period 16.0 [get_nets phy_pipe_quarter_clk]

create_clock -name phy_pipe_tx_phase_clk -period 4.0 [get_nets phy_pipe_tx_phase_clk]
...
set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets sys_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets sys_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_phase_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets sys_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_quarter_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets sys_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_tx_phase_clk]] -asynchronous
...
set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_phase_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_quarter_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_tx_phase_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_phase_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_quarter_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_half_phase_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_tx_phase_clk]] -asynchronous

set_clock_groups -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_quarter_clk]] -group [get_clocks -include_generated_clocks -of [get_nets phy_pipe_tx_phase_clk]] -asynchronous
