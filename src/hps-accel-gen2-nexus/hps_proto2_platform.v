...
wire soc_wait;
wire soc_done;
reg  [24:0] soc_count = 25'd25000000;
...
always @(posedge sys_clk) begin
	...
	if (soc_wait) begin
		...
		soc_count <= 25'd25000000;
	end
	{soc_hpssoc_tx_tick, soc_hpssoc_tx_phase} <= 24'd9895604;
	if (soc_hpssoc_tx_enable) begin
		{soc_hpssoc_tx_tick, soc_hpssoc_tx_phase} <= (soc_hpssoc_tx_phase + 24'd9895604);
	end
	...
	if (soc_hpssoc_rx_enable) begin
		{soc_hpssoc_rx_tick, soc_hpssoc_rx_phase} <= (soc_hpssoc_rx_phase + 24'd9895604);
	end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-01-06 18:49:37.
//------------------------------------------------------------------------------
