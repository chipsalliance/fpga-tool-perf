//--------------------------------------------------------------------------------
// Auto-generated by Migen (--------) & LiteX (b0578580) on 2020-05-06 12:15:39
//--------------------------------------------------------------------------------
module top (
  ...
  assign main_basesoc_uart_tx_fifo_syncfifo_din = {
    main_basesoc_uart_tx_fifo_fifo_in_last,
    main_basesoc_uart_tx_fifo_fifo_in_first,
    main_basesoc_uart_tx_fifo_fifo_in_payload_data
  };
  ...
  assign main_basesoc_uart_rx_fifo_syncfifo_din = {
    main_basesoc_uart_rx_fifo_fifo_in_last,
    main_basesoc_uart_rx_fifo_fifo_in_first,
    main_basesoc_uart_rx_fifo_fifo_in_payload_data
  };
  ...
  assign builder_roundrobin1_request = {
    ...
    (((main_litedramnativeport0_cmd_payload_addr[9:7] == 1'd1) & (~(((((((builder_locked2 | (main_sdram_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_sdram_interface_bank2_lock & (builder_roundrobin2_grant == 1'd0))) | (main_sdram_interface_bank3_lock & (builder_roundrobin3_grant == 1'd0))) | (main_sdram_interface_bank4_lock & (builder_roundrobin4_grant == 1'd0))) | (main_sdram_interface_bank5_lock & (builder_roundrobin5_grant == 1'd0))) | (main_sdram_interface_bank6_lock & (builder_roundrobin6_grant == 1'd0))) | (main_sdram_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_litedramnativeport0_cmd_valid)
  };
  ...
  assign builder_roundrobin6_request = {
    ...
    (((main_litedramnativeport0_cmd_payload_addr[9:7] == 3'd6) & (~(((((((builder_locked12 | (main_sdram_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_sdram_interface_bank1_lock & (builder_roundrobin1_grant == 1'd0))) | (main_sdram_interface_bank2_lock & (builder_roundrobin2_grant == 1'd0))) | (main_sdram_interface_bank3_lock & (builder_roundrobin3_grant == 1'd0))) | (main_sdram_interface_bank4_lock & (builder_roundrobin4_grant == 1'd0))) | (main_sdram_interface_bank5_lock & (builder_roundrobin5_grant == 1'd0))) | (main_sdram_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_litedramnativeport0_cmd_valid)
  };
  ...
  always @(*) begin
    ...
    case ({
      builder_new_master_wdata_ready5, builder_new_master_wdata_ready2
    })
      1'd1: begin
    ...
    case (builder_roundrobin0_grant)
      1'd0: begin
        builder_rhs_array_muxed12 <= {
          main_litedramnativeport0_cmd_payload_addr[23:10],
          main_litedramnativeport0_cmd_payload_addr[6:0]
        };
      end
      default: begin
        builder_rhs_array_muxed12 <= {
          main_litedramnativeport1_cmd_payload_addr[23:10],
          main_litedramnativeport1_cmd_payload_addr[6:0]
        };
      end
    endcase
  end
  ...
  reg [ 9:0] memadr;
  always @(posedge sys_clk) begin
    if (main_basesoc_ram_we[0]) mem_1[main_basesoc_ram_adr][7:0] <= main_basesoc_ram_dat_w[7:0];
    if (main_basesoc_ram_we[1]) mem_1[main_basesoc_ram_adr][15:8] <= main_basesoc_ram_dat_w[15:8];
    if (main_basesoc_ram_we[2]) mem_1[main_basesoc_ram_adr][23:16] <= main_basesoc_ram_dat_w[23:16];
    if (main_basesoc_ram_we[3]) mem_1[main_basesoc_ram_adr][31:24] <= main_basesoc_ram_dat_w[31:24];
